# -*- coding: utf-8 -*-
"""healthcare datset week 6 part b

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eZQLkLqU7LrkLaX6jBXY7ZM6nMKK9tSz
"""
...
The Monthly Admissions line chart shows the number of hospital admissions across different months. It helps identify monthly trends, increases, decreases, and fluctuations in patient admissions. This information can support hospital planning, staffing, and resource management.


The Correlation Matrix Heatmap shows the relationship between different variables in the dataset. The values range from -1 to +1, where values closer to +1 indicate a strong positive relationship, values closer to -1 indicate a strong negative relationship, and values near 0 indicate little or no linear relationship. The heatmap uses colours to make these relationships easy to identify. Overall, it helps in understanding which variables are strongly related and can support further data analysis and decision-making.
"""